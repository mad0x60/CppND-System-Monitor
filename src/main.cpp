...
int main() {
  ...
  std::cout << "OperatingSystem: " << LinuxParser::OperatingSystem()
            << std::endl;
  ...
  std::cout << "CpuUtilization: " << LinuxParser::CpuUtilization()[0]
            << std::endl;
  std::cout << "TotalProcesses: " << LinuxParser::TotalProcesses() << std::endl;
  std::cout << "RunningProcesses: " << LinuxParser::RunningProcesses()
            << std::endl;
